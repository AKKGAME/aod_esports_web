...
@section('title', 'Our Roster - Angels Of Death')
...
@section('content')
    ...
    <main>
        ...
        <section class="team-section fade-in-section" id="pubg">
            <div class="container">
                <div class="team-header">
                    <img src="{{ asset('https://www.pubgmobile.com/images/event/common/long_cache_30d/nav_logo.png?v=2') }}" alt="PUBG Logo" class="game-logo">
                    ...
                    @forelse ($allMembers as $member)
                        <div class="col-lg-3 col-md-6">
                            <div class="player-card">
                                <a href="{{ route('public.player.profile', ['player' => $member->ign]) }}" style="text-decoration: none; display: flex; flex-direction: column; height: 100%;">
                ...
                <div class="team-achievements mt-5 mb-5">
                    <h4 class="achievements-title">Team Achievements</h4>
                    <ul>
